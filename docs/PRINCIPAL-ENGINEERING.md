...
## Core boundary
**Primary concern:** Workflow orchestration.

Model workflow state explicitly; separate scheduling from task execution; make retries idempotency-aware; bound execution; persist enough state to diagnose interrupted workflows.
