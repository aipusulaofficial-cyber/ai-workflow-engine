...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Workflow state, scheduling/execution and retry boundaries and system boundaries |
| ADR | [0002-production-hardening.md](../ADRs/0002-production-hardening.md) | Explicit design trade-offs and production boundaries |
| Contracts | [tests/test_workflow.py](../tests/test_workflow.py) | Contract-focused validation at the repository boundary |
